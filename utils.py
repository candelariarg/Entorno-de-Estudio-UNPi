...
# ==========================================
# CONSTANTES ORIGINALES (No tocar)
# ==========================================
...
def _actualizar_hijos(window, bg, fg, bg_sec, es_oscuro):
    for child in window.GetChildren():
        ...
        # 1. BOTONES: Dejamos que Linux los dibuje con su motor nativo 
        if isinstance(child, (wx.Button, wx.ToggleButton, wx.SpinCtrl)):
            pass 
            
        # 2. EDITOR ENRIQUECIDO: Arregla las "Letras negras en fondo negro"
        ...
        # 3. LISTAS (ListCtrl): Arregla la cabecera blanca invisible
        ...
        # 4. ÁRBOLES (TreeCtrl): Tu regla original
        ...
        # 5. CAJAS DE TEXTO SIMPLES Y LISTBOXES
        elif isinstance(child, (wx.TextCtrl, wx.ListBox)):
            child.SetBackgroundColour(bg_sec)
            child.SetForegroundColour(fg)
            
        # 6. PANELES NORMALES Y TEXTOS ESTÁTICOS
        else:
...
# ==========================================
# FUNCIÓN ORIGINAL DE EXPORTACIÓN PDF
# ==========================================
